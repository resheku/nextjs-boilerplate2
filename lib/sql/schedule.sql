...
select 
  ...
  COUNT(*) FILTER (WHERE points = 2) AS "II",
  COUNT(*) FILTER (WHERE points = 1) AS "III",
  COUNT(*) FILTER (WHERE score = '0') AS "IV",
  COUNT(*) FILTER (WHERE score = 'D') AS "R",
  COUNT(*) FILTER (WHERE score = 'T') AS "T",
  COUNT(*) FILTER (WHERE score = 'M') AS "M",
  COUNT(*) FILTER (WHERE score = 'W') AS "X",
  COUNT(*) FILTER (WHERE score = 'U') AS "F",
